...
fun main() {
    ...
    val trace1 = Box {
        x.set(listOf(0.2, 0.2, 0.6, 1.0, 0.5, 0.4, 0.2, 0.7, 0.9, 0.1, 0.5, 0.3))
        y.set(y0)
        name = "kale"
        marker {
            color("#3D9970")
    ...
    val trace2 = Box {
        x.set(listOf(0.6, 0.7, 0.3, 0.6, 0.0, 0.5, 0.7, 0.9, 0.5, 0.8, 0.7, 0.2))
        y.set(y0)
        name = "radishes"
        marker {
            color("#FF4136")
    ...
    val trace3 = Box {
        x.set(listOf(0.1, 0.3, 0.1, 0.9, 0.6, 0.6, 0.9, 1.0, 0.3, 0.6, 0.8, 0.5))
        y.set(y0)
        name = "carrots"
        marker {
            color("#FF851B")
